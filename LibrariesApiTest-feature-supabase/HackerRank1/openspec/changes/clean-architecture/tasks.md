...
- [ ] 1.1 Create folder structure: Domain/Entities, Domain/Interfaces, Application/Interfaces, Application/DTOs, Infrastructure/Data, Infrastructure/Services, Infrastructure/Helpers, Presentation/Controllers

## 2. Domain Layer (Center — no dependencies)

- [ ] 2.1 Move Book and Library entities from Data/ to Domain/Entities/ and update namespace to `LibraryService.WebAPI.Domain.Entities`
- [ ] 2.2 Remove EF Core `[Key]` attributes from Book and Library entities — rely on convention-based configuration
- [ ] 2.3 Create ILibraryRepository interface in Domain/Interfaces/ with methods: GetById, GetAll, Add, Update, Delete
- [ ] 2.4 Create IBookRepository interface in Domain/Interfaces/ with methods: GetByLibraryId, GetById, Add, Update, Delete
